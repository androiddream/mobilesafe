package com.example.leemobilesafe.service;
...
import com.example.leemobilesafe.db.NumberAddressDao;
...
public class ShowCallLocationService extends Service {
    ...
    //"半透明", "活力橙", "卫士蓝", "苹果绿", "金属灰"
    public static final int[] bg_styles = {R.drawable.bg_normal,
            R.drawable.bg_normal, R.drawable.bg_normal,
            R.drawable.bg_normal, R.drawable.bg_normal};
